    ...
    <div class="slides" style="--slides-num:7; left: calc(0%);">
      <div class="project-card">
        ...
        <div class="card-body">
          ...
          <div class="card-action"><a href="https://ray.pdis.nat.gov.tw/taipei_service/" class="button">看更多</a></div>
        </div>
      </div>
      <div class="project-card">
        ...
        <div class="card-body">
          ...
          <div class="card-action"><a href="https://ray.pdis.nat.gov.tw/klcg/" class="button">看更多</a></div>
        </div>
      </div>
      <div class="project-card">
        ...
        <div class="card-body">
          ...
          <div class="card-action"><a href="https://ray.pdis.nat.gov.tw/yda/" class="button">看更多</a></div>
        </div>
      </div>
      <div class="project-card">
        ...
        <div class="card-body">
          ...
          <div class="card-action"><a href="https://ray.pdis.nat.gov.tw/edesk_bli/" class="button">看更多</a></div>
        </div>
      </div>
      <div class="project-card">
        ...
        <div class="card-body">
          ...
          <div class="card-content">
            ...
            <div class="members">
              ...
              <div class="avatar"><img src="https://ray.pdis.nat.gov.tw/_nuxt/img/67670b2ac9b675f3542886af828035d7.dc8d0ac.jpg"
          ...
          <div class="card-action"><a href="https://ray.pdis.nat.gov.tw/taichung_society/" class="button">看更多</a></div>
        </div>
      </div>
      <div class="project-card">
        ...
        <div class="card-body">
          ...
          <div class="card-action"><a href="https://ray.pdis.nat.gov.tw/tpech/" class="button">看更多</a></div>
        </div>
      </div>
      <div class="project-card">
        ...
        <div class="card-body">
          ...
          <div class="card-action"><a href="https://ray.pdis.nat.gov.tw/taiwan_jobs/" class="button">看更多</a></div>
        </div>
      </div>
    </div>
  </div>
...
PDIS 也將同學們精彩的成果全部公布在網路上，有興趣的朋友們歡迎至[Ray成果網站](https://ray.pdis.nat.gov.tw/)觀看每一組同學們兩個月來精彩的服務設計改造全記錄！
